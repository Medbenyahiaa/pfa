        ...
        <div class="sidebar-wrapper" id="sidebar-wrapper">
          ...
          @if(Auth::user()->role == 'admin')
            ...
            <li @if( request()->is('homeAdmin') ) class="activeItem" @endif>
              <a class="icon-link" href="/homeAdmin">
...
S412.45,452.911,408.309,452.911z"/>
           ...
           @endauth
            ...
            <li @if( request()->is('homeBeneficiare') ) class="activeItem" @endif>
              <a class="icon-link" href="/homeBeneficiare">
                <svg  class="icon" version="1.1" id="_x31_" enable-background="new 0 0 24 24" height="33.669px" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
                  <g>
                  <path d="m22.5 18h-13c-.827 0-1.5-.673-1.5-1.5v-9c0-.827.673-1.5 1.5-1.5h13c.827 0 1.5.673 1.5 1.5v9c0 .827-.673 1.5-1.5 1.5zm-13-11c-.275 0-.5.224-.5.5v9c0 .276.225.5.5.5h13c.275 0 .5-.224.5-.5v-9c0-.276-.225-.5-.5-.5z"/></g>
                  <g>
                  <path d="m14.5 15c-.276 0-.5-.224-.5-.5v-3.5c0-.551-.448-1-1-1s-1 .449-1 1v3.5c0 .276-.224.5-.5.5s-.5-.224-.5-.5v-3.5c0-1.103.897-2 2-2s2 .897 2 2v3.5c0 .276-.224.5-.5.5z"/></g>
                  <g>
                  <path d="m14.5 13h-3c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h3c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  <g>
                  <path d="m18.5 15h-1c-.276 0-.5-.224-.5-.5v-5c0-.276.224-.5.5-.5h1c1.379 0 2.5 1.122 2.5 2.5v1c0 1.378-1.121 2.5-2.5 2.5zm-.5-1h.5c.827 0 1.5-.673 1.5-1.5v-1c0-.827-.673-1.5-1.5-1.5h-.5z"/></g>
                  <g>
                  <path d="m5.5 8h-5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h5c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  <g><path d="m5.5 11h-5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h5c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  <g>
                  <path d="m5.5 14h-5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h5c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g><g><path d="m5.5 17h-5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h5c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  <g><path d="m23.5 1h-23c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h23c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  <g>
                  ...
                  <g><path d="m23.5 24h-23c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h23c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                  </g>
                  </svg>
          ...
          <li @if( request()->is('write') ) class="activeItem" @endif>
            <a class="icon-link" href="/write">
              <svg   class="icon" version="1.1" id="_x31_" enable-background="new 0 0 24 24" height="33.669px" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"><g><path d="m14.5 4.5h-5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h5c.276 0 .5.224.5.5s-.224.5-.5.5z"/></g><g><path d="m20.5 24h-17c-.276 0-.5-.224-.5-.5v-19.5c0-.276.224-.5.5-.5h2c.276 0 .5.224.5.5s-.224.5-.5.5h-1.5v18.5h16v-18.5h-1.5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h2c.276 0 .5.224.5.5v19.5c0 .276-.224.5-.5.5z"/></g><g><path d="m9.5 6h-4c-.276 0-.5-.224-.5-.5v-3c0-.276.224-.5.5-.5h4c.276 0 .5.224.5.5v3c0 .276-.224.5-.5.5zm-3.5-1h3v-2h-3z"/></g><g><path d="m18.5 6h-4c-.276 0-.5-.224-.5-.5v-3c0-.276.224-.5.5-.5h4c.276 0 .5.224.5.5v3c0 .276-.224.5-.5.5zm-3.5-1h3v-2h-3z"/></g><g><path d="m7.5 3c-.276 0-.5-.224-.5-.5v-2c0-.276.224-.5.5-.5s.5.224.5.5v2c0 .276-.224.5-.5.5z"/></g><g><path d="m16.5 3c-.276 0-.5-.224-.5-.5v-2c0-.276.224-.5.5-.5s.5.224.5.5v2c0 .276-.224.5-.5.5z"/></g><g><path d="m10.5 14c-.276 0-.5-.224-.5-.5v-3.5c0-.551-.448-1-1-1s-1 .449-1 1v3.5c0 .276-.224.5-.5.5s-.5-.224-.5-.5v-3.5c0-1.103.897-2 2-2s2 .897 2 2v3.5c0 .276-.224.5-.5.5z"/></g><g><path d="m10.5 12h-3c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h3c.276 0 .5.224.5.5s-.224.5-.5.5z"/></g><g><path d="m14.5 14h-1c-.276 0-.5-.224-.5-.5v-5c0-.276.224-.5.5-.5h1c1.379 0 2.5 1.122 2.5 2.5v1c0 1.378-1.121 2.5-2.5 2.5zm-.5-1h.5c.827 0 1.5-.673 1.5-1.5v-1c0-.827-.673-1.5-1.5-1.5h-.5z"/></g><g><path d="m16.5 17h-9c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h9c.276 0 .5.224.5.5s-.224.5-.5.5z"/></g><g><path d="m16.5 20h-9c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h9c.276 0 .5.224.5.5s-.224.5-.5.5z"/></g></svg>
            ...
            <li @if( request()->is('homeDonateur') ) class="activeItem" @endif>
              <a class="icon-link" href="/homeDonateur">
                  <svg class="icon" style="margin-right: 15px" viewBox="0 0 496 496" xmlns="http://www.w3.org/2000/svg"><path d="m472 16h-73.472656c-3.3125-9.289062-12.113282-16-22.527344-16h-112c-10.414062 0-19.214844 6.710938-22.527344 16h-73.472656c-13.230469 0-24 10.769531-24 24v104h-27.246094c-9.738281 0-19.347656 2.550781-27.792968 7.382812l-43.089844 24.617188h-45.871094v144h53.574219l33.890625 22.59375c9.230468 6.160156 19.976562 9.40625 31.0625 9.40625h25.472656v120c0 13.230469 10.769531 24 24 24h304c13.230469 0 24-10.769531 24-24v-432c0-13.230469-10.769531-24-24-24zm-280 192h16c17.648438 0 32-14.351562 32-32s-14.351562-32-32-32h-16v-80h49.472656c3.3125 9.289062 12.113282 16 22.527344 16h112c10.414062 0 19.214844-6.710938 22.527344-16h49.472656v384h-256zm64-184c0-4.414062 3.585938-8 8-8h112c4.414062 0 8 3.585938 8 8v32c0 4.414062-3.585938 8-8 8h-112c-4.414062 0-8-3.585938-8-8zm-96 16c0-4.414062 3.585938-8 8-8h72v16h-64v96h-16zm-41.472656 296c-7.917969 0-15.589844-2.320312-22.183594-6.71875l-37.917969-25.28125h-42.425781v-112h34.128906l46.773438-26.726562c6.035156-3.449219 12.898437-5.273438 19.851562-5.273438h91.246094c8.824219 0 16 7.175781 16 16s-7.175781 16-16 16h-96v8c0 22.054688-17.945312 40-40 40v16c28.167969 0 51.535156-20.894531 55.433594-48h16.566406v128zm361.472656 136c0 4.414062-3.585938 8-8 8h-304c-4.414062 0-8-3.585938-8-8v-264h16v256h288v-416h-64v-16h72c4.414062 0 8 3.585938 8 8zm0 0"/><path d="m272 32h16v16h-16zm0 0"/><path d="m352 32h16v16h-16zm0 0"/><path d="m378.984375 369.671875-27-7.710937-.007813-4.058594c14.503907-10.125 24.023438-26.910156 24.023438-45.902344v-16c0-30.871094-25.128906-56-56-56s-56 25.128906-56 56v16c0 18.976562 9.511719 35.753906 24 45.886719v4.082031l-26.992188 7.703125c-17.078124 4.886719-29.007812 20.703125-29.007812 38.472656v23.855469h176v-23.855469c0-17.769531-11.929688-33.585937-29.015625-38.472656zm-98.984375-57.671875v-16c0-22.054688 17.945312-40 40-40s40 17.945312 40 40v16c0 22.054688-17.945312 40-40 40s-40-17.945312-40-40zm55.71875 53.710938-15.71875 20.953124-15.71875-20.953124c4.992188 1.464843 10.261719 2.289062 15.71875 2.289062s10.726562-.824219 15.71875-2.289062zm56.28125 50.289062h-144v-7.855469c0-10.65625 7.160156-20.152343 17.40625-23.082031l27.496094-7.855469 27.097656 36.128907 27.097656-36.128907 27.496094 7.855469c10.246094 2.929688 17.40625 12.425781 17.40625 23.082031zm0 0"/><path d="m208 96h16v16h-16zm0 0"/><path d="m240 96h192v16h-192zm0 0"/><path d="m256 128h176v16h-176zm0 0"/><path d="m256 160h176v16h-176zm0 0"/><path d="m416 192h16v16h-16zm0 0"/><path d="m256 192h144v16h-144zm0 0"/></svg>
                  <div>Liste Des Annonce</div>
              </a>
             </li>
